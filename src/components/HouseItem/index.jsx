          ...
          <Section>
            <Content flex icons>
              ...
              <div>
                <Icons.Years />
                <p className="subTitle">
                  Year Built: {data.houseDetails && data.houseDetails.yearBuilt}
                </p>
              </div>
            </Content>
            <Content>
          ...
          <Section>
            <Content>
              ...
              <p className="subTitle text">
                ...
                perspiciatis provident est illum magnam iusto deleniti obcaecati
                sunt eius dolorem similique voluptatem tempore autem mollitia
                perferendis? Sit cupiditate iste nemo deserunt. Suscipit, neque
                est! Odio perspiciatis distinctio doloremque amet quasi adipisci
                sequi voluptatum error modi provident voluptate, rerum
                praesentium? Consectetur corrupti ipsa molestias, odit ullam
                veniam quas pariatur ipsam. Esse fugiat ipsa minima temporibus.
                Eos asperiores possimus rerum ab corporis, labore debitis
                facilis maiores dolore aut. Eveniet sit saepe hic dignissimos
                eum, a distinctio fuga. Voluptate voluptates quisquam
                architecto, natus numquam vero illo? Rerum in doloribus,
                aspernatur qui dicta quo placeat reprehenderit, repellat a, quis
                voluptates hic perspiciatis possimus esse doloremque. Recusandae
                explicabo, quae
              </p>
              <a href="./">Show more</a>
            </Content>
